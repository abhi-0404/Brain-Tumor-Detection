...
- `image-1.png`: CNN architecture diagram
- `image-2.png`: CNN training curves
- `image-3.png`: MLP training curves
- `image-5.png`: VGG16 training curves
- `image-10.png`: CNN confusion matrix
- `image-11.png`: VGG16 confusion matrix
